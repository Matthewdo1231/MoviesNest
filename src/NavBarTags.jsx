  ...
  return (
    <div className='hidden lg:block w-[36rem]'>
        <ul className='flex items-center justify-around text-white font-bold'>
            ...
            <li className='hover:cursor-pointer hover:text-orange-300'><Link to="/movies">MOVIES</Link></li>
            <li className='hover:cursor-pointer hover:text-orange-300'><Link to="/series">SERIES</Link></li>
        </ul>
    </div>
  )
}
